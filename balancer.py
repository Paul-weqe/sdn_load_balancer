...
class MemoryEntry (object):
  ...
  Table entries in the switch "remember" flows for a period of time, but rather than set their expirations to some long value ,
  we let them expire from the switch relatively quickly and remember them here in the controller for longer.
  """
